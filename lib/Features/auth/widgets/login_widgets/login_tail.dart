...
import 'package:flutter_application_2/Features/auth/screens/signup_view.dart';
import 'package:flutter_application_2/Features/doctor_side/view/signup_view.dart';
...
class LoginTaildoc extends StatelessWidget {
  final String signUp;
    final String create;

  const LoginTaildoc({super.key, required this.signUp, required this.create});
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        TextButton(onPressed:(){
          Navigator.push(context,
          MaterialPageRoute(builder:(context) => SignupViewdoc())
          );
        }, child: Text(signUp,style: TextStyle(color: AppColors.blueColor,fontSize:18,fontWeight: FontWeight.bold),))
        ],)
      ],
