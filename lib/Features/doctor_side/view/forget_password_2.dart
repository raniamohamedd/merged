...
class ForgotpasswordView2doc extends StatefulWidget {
  
  

  const ForgotpasswordView2doc({super.key});

  @override
  State<ForgotpasswordView2doc> createState() => _ForgotpasswordViewState();
}

class _ForgotpasswordViewState extends State<ForgotpasswordView2doc> {
