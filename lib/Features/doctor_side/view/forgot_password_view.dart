...
class ForgotpasswordViewdoc extends StatefulWidget {
  const ForgotpasswordViewdoc({super.key});

  @override
  State<ForgotpasswordViewdoc> createState() => _ForgotpasswordViewState();
}

class _ForgotpasswordViewState extends State<ForgotpasswordViewdoc> {
