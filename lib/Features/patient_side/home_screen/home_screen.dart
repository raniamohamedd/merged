...
const List<String> _dosageOptions = [
  ...
  '500 mg',  '625 mg',  '750 mg',  '875 mg',  '1000 mg', '1 g',
...
class _PatientDashboardUIState extends State<HomeScreen> {
                        ...
                        Expanded(
                          child: ElevatedButton(
                            ...
                            onPressed: () => Navigator.pop(
                                context,
                                _formatTime12(selectedHour, selectedMinute,
                                    selectedPeriod)),
          ...
          content: Column(
            ...
            children: [
              ListTile(
                ...
                subtitle:
                    const Text("Use camera & AI to detect medication"),
                onTap: () {
                  Navigator.pop(context);
              ...
              ListTile(
                ...
                subtitle:
                    const Text("Enter medication details manually"),
                onTap: () {
                  Navigator.pop(context);
                  openManualAddDialog();
                },
  ...
  void openManualAddDialog() {
    // ── local state (كله جوا الـ function) ──
    String? selectedMedName;
    bool    isOtherSelected = false;
    String  medName         = "";
    String  dosage          = "";
    String? selectedDosage;          // ✅ dropdown الجرعة
    String  sideEffects     = "";
    ...
    // ✅ أسماء الأدوية الموجودة — لمنع التكرار
                                ...
                                onTap: () {
                                  ...
                                  setDialogState(() {
                                    ...
                                    if (!isOther) {
                                      ...
                                      // ✅ اقترح الجرعة الافتراضية في الـ dropdown
                                      selectedDosage =
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: selectedMedName == null || isLoading
                            ...
                            : () async {
                                ...
                                // ✅ Double-check منع التكرار
                                if (existingNames.contains(
                                    finalName.toLowerCase())) {
                                  ScaffoldMessenger.of(dialogContext)
                                      .showSnackBar(SnackBar(
                                    content: Text(
                                        "$finalName is already added"),
                                    backgroundColor: Colors.orange,
                                  ));
                                  return;
                                }
            ...
            ...["high", "medium", "low"].map((level) {
              ...
              return Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(16),
                  border:
                      Border.all(color: warningColor(level).withOpacity(.25)),
                ),
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
